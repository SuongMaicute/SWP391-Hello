...
public class ProductDAO {
        ...
        try {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    Product result = new 
        Product(productID, productName, priceIn, type, category, quantity, description, status, img, sku, null, priceOut, pSale);
        ...
        try {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    result = new Product
        (productID, productName, priceIn, type, category, quantity, description, status, img, sku, null, priceOut, pSale);
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        List<Product> listProduct = productDAO.printProductList();
