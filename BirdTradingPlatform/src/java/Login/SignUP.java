...
public class SignUP extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
           ...
           UserDTO checkEmail = dao.CheckLoginbyGmail(email);
           ...
           if (err==false){
               UserDTO save = new UserDTO ("2", email, userName, 0, pass,
                       "https://i.pinimg.com/564x/2f/e6/a5/2fe6a575ad7b7baabf6dd536b1496a50.jpg", false, false);
               dao.SaveUser(save);
               url = "Homepage.html";
           }
