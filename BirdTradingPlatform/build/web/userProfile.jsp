...
<html lang="en">
    ...
    <body>
        ...
        <c:if test="${empty servlet}">
            <c:redirect url="getDataforUserProfileController">
                    ...
                    <div class="panel">
                        ...
                        <ul class="nav  navbar">
                            ...
                            <li>
                                ...
                                <form action="resetPassController">
                                    <input id="content" type="submit" name="reset" value="Please check your Gmail" >
                                </form>
                            </li>
                                        ...
                                        <div class="bio-desk">
                                            <form action="updateProfileController">
                                                ...
                                                <c:if test="${ not empty User.username}">
                                                    ...
                                                    <p> <input class="submit" type="submit" name="Change"
                                                               value="Update your name" /></p>
