        ...
        <div class= "container">
            ...
            <form action="" class="from">
                <div class ="input-group">
                    ...
                    <input type = "passwork" name="passwork" placeholder ="Code">
                    <span class="icon">&#128274;</span>
                </div>
                <div class ="input-group">
                    <label for ="" class="label-title">Enter a new password</label>
                    <input type = "passwork" name="passwork" placeholder ="New Password">
                    <span class="icon">&#128274;</span>
                </div>
                <div class ="input-group">
                    <label for ="" class="label-title">
                        Password Re-authentication</label>
                    <input type = "passwork" name="passwork" placeholder ="Confirm Your Password">
                    <span class="icon">&#128274;</span>
                </div>
                <div class="input-group">
                    <button class="submit-btn" type = "sumit">Reset Your Password</button>
